...
class CoffeeProcess
{
    ...
    #[ORM\Column(name: "coffe_images", type: "json", nullable: true)]
    private $coffeImages = [];
    ...
    public function getCoffeImages(): array
    {
        return $this->coffeImages;
    }

    public function setCoffeImages(array $coffeImages): void
    {
