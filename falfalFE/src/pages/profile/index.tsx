...
const ProfileSave = () => {
  ...
  const [maritalStatus, setMaritalStatus] = useState<'married' | 'single' | 'engaged' | 'widowed'>('single');
  ...
  const [employmentStatus, setEmploymentStatus] = useState<'full-time' | 'part-time' | 'unemployed'>('unemployed');
  const [educationLevel, setEducationLevel] = useState<'primary school' | 'secondary school' | 'high school' | 'vocational school' | 'university' | 'master`s or doctoral'>('primary school');
        ...
        <form onSubmit={handleSubmit}>
          <Styled.ProfileWrapper>
            ...
            <Input
                ...
                label="İlişki Durumu"
                value={maritalStatus}
                onChange={(e) => setMaritalStatus(e.target.value as 'married' | 'single' | 'engaged' | 'widowed')}
                options={[
            ...
            <Input
                ...
                onChange={(e) => setEmploymentStatus(e.target.value as 'full-time' | 'part-time' | 'unemployed')}
                options={[
            ...
            <Input
                ...
                onChange={(e) => setEducationLevel(e.target.value as 'primary school' | 'secondary school' | 'high school' | 'vocational school' | 'university' | 'master`s or doctoral')}
                  options={[
                ...
                { value: 'master`s or doctoral', label: 'Yüksek Lisans ve Doktora' },
                  ]}
                  />
                  <Input
                  type="text"
  ...
  ProfileSave.getLayout = (page: ReactElement) => <SimpleLayout>{page}</SimpleLayout>;
